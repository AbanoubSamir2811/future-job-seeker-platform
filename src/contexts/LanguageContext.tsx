...
const translations = {
  ar: {
    ...
    'remove': 'حذف',
    'profile_updated': 'تم حفظ الملف الشخصي',
    'profile_saved_success': 'تم حفظ بياناتك بنجاح',
    'update_personal_info': 'قم بتحديث بياناتك الشخصية والمهنية',
    'click_camera_change': 'اضغط على الكاميرا لتغيير الصورة',
    ...
    'work_preference': 'دوام كامل، عن بعد',
    'add_new_skill': 'أضف مهارة جديدة',
    'add_new_language': 'أضف لغة جديدة',
    'personal_summary': 'نبذة شخصية',
    'write_summary': 'اكتب نبذة مختصرة عن خبراتك وأهدافك المهنية',
    'bachelor_computer': 'بكالوريوس هندسة الحاسوب',
    'king_saud_university': 'جامعة الملك سعود',
    'gpa_value': '3.8 / 4.0',
    'work_experience': 'الخبرات العملية',
    'experience_number': 'خبرة #{index}',
    'company_name': 'اسم الشركة',
    'tech_company': 'شركة التقنية',
    'job_position': 'المنصب',
    'start_date_label': 'تاريخ البداية',
    'end_date_label': 'تاريخ النهاية',
    'tasks_description': 'وصف المهام',
    'tasks_placeholder': 'اكتب وصفاً للمهام التي قمت بها في هذا المنصب',
  ...
  en: {
    ...
    'click_camera_change': 'Click camera to change image',
    ...
    'work_preference': 'Full-time, Remote',
    'add_new_skill': 'Add new skill',
    'add_new_language': 'Add new language',
    'personal_summary': 'Personal Summary',
    'write_summary': 'Write a brief summary about your experience and career goals',
    'bachelor_computer': 'Bachelor of Computer Engineering',
    'king_saud_university': 'King Saud University',
    'gpa_value': '3.8 / 4.0',
    'work_experience': 'Work Experience',
    'experience_number': 'Experience #{index}',
    ...
    'tasks_placeholder': 'Write a description of the tasks you performed in this position',
